        ...
        return(
            <div className="ultimosClientes">
                ...
                <Card style={{ width: '18rem', margin:'2rem'}}>
                    ...
                    <Card.Body>
                    <Card.Title className="cardtitle"> <a href="">Restarurante La era</a> </Card.Title>
                    <Card.Text  className="cardtext">Da Click en la imagen y ve como puede ser tú menu</Card.Text>
                    <Card.Footer className="cardfooter">Creo menús digitales con código QR para facilitar las consultas de los usuarios, los menús están pensados en
                ...
                <Card style={{ width: '18rem', margin:'2rem'}}>
                    ...
                    <Card.Footer className="cardfooter">Haz que tus clientes te conozcan y tus productos de manera más rápida y sencilla, haz que te encuentren y a tus productos con la mejor presentación
                    </Card.Footer>
                    </Card.Body>
                </Card>
                <Card style={{ width: '18rem', margin:'2rem'}}>
                    ...
                    <Card.Body>
                    <Card.Title className="cardtitle"> <a href="">José Salia</a></Card.Title>
                    <Card.Text  className="cardtext">
                        Conoce el caso de José y como su tarjete ayudo a crecer sus ventas
                    </Card.Text>
                    <Card.Footer className="cardfooter">Para los profesionales que quieren compartir sus datos de manera rápida y eficaz, eres vendedor es la manera más rapida de comportir tú contacto.</Card.Footer>
                    </Card.Body>
                </Card>
                </CardGroup>
            </div>
